...
public class MemCachedClient {
		...
		try {
			...
			if (DELETED.equals(line)) {
				...
				log.error(new StringBuffer()
						...
						.toString());
				log.error(new StringBuffer().append("++++ server response: ")
	...
	public Object get(String key, Integer hashCode, boolean asString) {
		...
		try {
			...
			while (true) {
				String line = sock.readLine();
				System.out.println(" sock.readLine()" + line);
				...
				if (line.startsWith(VALUE)) {
					...
					System.out.println("sock.readBytes(length) "
							+ new String(buf));
	...
	public Map<String, Object> getMulti(String[] keys, Integer[] hashCodes,
		...
		if (log.isInfoEnabled())
			log.info(new StringBuffer().append("multi get socket count : ")
